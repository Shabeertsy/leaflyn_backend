...
def global_data(request):
    ...
    dashboard_data = {
            ...
            "orders_change": round(orders_change_percentage, 2), 
            "orders_change_period": "Since last week",
            "orders_change_is_positive": orders_change_percentage >= 0,
            
            "new_users": new_users_last_week,
            "new_users_change": round(new_users_change_percentage, 2), 
            "new_users_change_period": "Since last week",
            "new_users_change_is_positive": new_users_change_percentage >= 0,
    ...
    dashboard_notifications = list(dashboard_notifications_qs[:5])
