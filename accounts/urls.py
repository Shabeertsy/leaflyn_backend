...
urlpatterns = [
    ...
    path('personal-transactions/', views.PersonalTransactionListCreateAPIView.as_view(), name='personal-transaction-list-create'),
    path('personal-transactions/<int:pk>/', views.PersonalTransactionRetrieveUpdateDestroyAPIView.as_view(), name='personal-transaction-detail'),
]
